...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
     return api.sendMessage("Ꮆɵɵɗ Ɱ❍ɽƞɪɪƞɠ Ɛⱱɛɽɣ❍ɽ Ƭɽɣ ꌗɵɱɛ Cɵffɛɛ ❍ɽ Ƭɛɑ Ƭ❍ Ꮗɑҡɛ Uƥ☕✨💫", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
   ...
   if ((event.body.toLowerCase() == "nobody loves me") || (event.body.toLowerCase() == "nobody love me") || (event.body.toLowerCase() == "koi pyar nhi karta")) {
     return api.sendMessage("️Me huna baby mere pass aao 🥰🤗. Me kar unga na aapko payar 🙈 (londo tum dur hi rahna saalo 😑)", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "lob you") || (event.body.toLowerCase() == "i lob you")) {
   ...
   if ((event.body.toLowerCase() == "&fuck") || (event.body.toLowerCase() == "&Fuck")) {
     return api.sendMessage("🏔️🏝️Priyansh Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣɵ Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑ ƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "food") || (event.body.toLowerCase() == "khana")) {
    var food = ["Pizza", "Burger", "Sandwich", "Pasta", "Noodles", "Fries", "Chicken", "Mutton", "Fish", "Eggs", "Rice", "Roti", "Dal", "Vegetables", "Fruits", "Salad", "Soup", "Juice", "Shakes", "Ice Cream", "Cakes", "Pastries", "Cookies", "Chocolates"];
    var randFood = food[Math.floor(Math.random() * food.length)];
    return api.sendMessage(`Khana khao, ${randFood} kha lo`, threadID);
  };

  if ((event.body.toLowerCase() == "drink") || (event.body.toLowerCase() == "peene ka")) {
    var drink = ["Water", "Juice", "Shakes", "Milk", "Tea", "Coffee", "Cold Drink", "Beer", "Wine", "Whiskey", "Rum", "Vodka", "Gin", "Cocktail", "Mocktail"];
    var randDrink = drink[Math.floor(Math.random() * drink.length)];
    return api.sendMessage(`Pee lo, ${randDrink} pee lo`, threadID);
  };

  if ((event.body.toLowerCase() == "sweet") || (event.body.toLowerCase() == "mithai")) {
    var sweet = ["Gulab Jamun", "Jalebi", "Rasgulla", "Barfi", "Ladoo", "Pedha", "Kulfi", "Ice Cream", "Cakes", "Pastries", "Cookies", "Chocolates"];
    var randSweet = sweet[Math.floor(Math.random() * sweet.length)];
    return api.sendMessage(`Mithai kha lo, ${randSweet} kha lo`, threadID);
  };

  if ((event.body.toLowerCase() == "fruit") || (event.body.toLowerCase() == "phal")) {
    var fruit = ["Apple", "Banana", "Mango", "Orange", "Grapes", "Watermelon", "Pineapple", "Strawberry", "Blueberry", "Raspberry", "Kiwi", "Peach", "Cherry", "Plum", "Pomegranate"];
    var randFruit = fruit[Math.floor(Math.random() * fruit.length)];
    return api.sendMessage(`Phal kha lo, ${randFruit} kha lo`, threadID);
  };
